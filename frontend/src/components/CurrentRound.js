    ...
    <div className="card grow md:w-1/2 divide-y divide-solid dark:divide-slate-600">
      ...
      ? <div className="divide-y divide-dashed dark:divide-slate-600 flex flex-col">
          ...
          <div className="grow px-4 py-2">
            ...
            <button className="rounded-full my-2 font-bold dark:bg-slate-700 bg-white px-4 py-2 text-lg ring-1 dark:ring-slate-500 ring-slate-300 shadow-lg dark:text-slate-100">Toss ETH into the pot</button>
          </div>
        </div>
